...
RPbdb_Directory* RPbdb_Directory_new( char* directory_path )	{
	
	RPbdb_Directory*	new_directory	=	calloc( 1, sizeof( RPbdb_Directory ) );
...
void RPbdb_Directory_internal_ensureDirectoryPathExistsForFile( char* file_path )	{
